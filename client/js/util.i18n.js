...
const LANGUAGES = {
	...
	zh: {
		...
		translations: {
			...
			'ui.username': '用户名',
			'ui.node_name': '聊天室名称',
			'ui.node_password': '聊天室密码',
			'ui.optional': '（可选）',
			'ui.enter': '确定',
			'ui.connecting': '连接中...',
			'ui.node_exists': '此聊天室已存在',
			'ui.my_name': '我的名字',
			'ui.members': '在线成员',
			'ui.message': '消息',
			...
			'help.password_enhanced_encryption_desc': '聊天室密码直接参与加密密钥生成，提供额外的安全保护层',
			...
			'help.room_isolation_note': '相同聊天室但不同密码的是两个完全独立的房间，无法相互通信。',
			'help.tip_private_chat': '私人对话',
			'help.tip_private_chat_desc': '使用复杂的聊天室和密码，只分享给特定人员',
			'help.tip_group_chat': '群聊',
			'help.tip_group_chat_desc': '使用简单易记的聊天室和密码，方便多人加入',
			'help.tip_security_reminder': '安全提醒',
			'help.tip_security_reminder_desc': '聊天室和密码都需要完全一致才能进入同一个房间',
